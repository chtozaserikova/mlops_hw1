...
- `pyproject.toml` — конфигурация Poetry с зависимостями проекта (Flask, gRPC, scikit-learn, Streamlit и др.)
- `poetry.lock` — фиксированные версии всех зависимостей (обязателен по условиям задания)
### Тестирование:
